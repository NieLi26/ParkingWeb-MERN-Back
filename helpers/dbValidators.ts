...
const existeTarifaPorId = async ( id: number ): Promise<void> => {
...
const existeReservaPorId = async ( id: number ): Promise<void> => {
...
const existeLotePorId = async ( id: number ): Promise<void> => {
...
const existePagoPorId = async ( id: number ): Promise<void> => {
...
const emailOcupado = async ( email: string = '' ): Promise<void> => {
