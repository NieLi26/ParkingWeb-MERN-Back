...
import { Lote, Reserva } from "../models/index";
...
const obtenerLote = async ( req: Request, res: Response ) => {
    const { id } = req.params;
...
const actualizarLote = async ( req: Request, res: Response ) => {
    const { id } = req.params;
    const { numero } = req.body;
...
const eliminarLote = async ( req: Request, res: Response ) => {
    const { id } = req.params;
...
const buscarReserva = async ( req: Request, res: Response ) => {
    const { id } = req.params;
    try {
